        ...
        <div className="col">
            <div className="mainBody row">
                ...
                <div className="col-12 col-lg-6 cardBody ">
                    <i className="fa-solid fa-quote-left fs-1 red"></i>
                    <p className="m-0 cardDescription">{description}</p>
                    <h5 className='text-end cardName'>- {name}</h5>
                    {
                        starArray.slice(0, rating).map(star => <i key={star} className="fa-solid fa-star red"></i>)
                    }
                    {
                        starArray.slice(rating, 5).map(star => <i key={star} className="fa-solid fa-star-half red"></i>)
                    }
