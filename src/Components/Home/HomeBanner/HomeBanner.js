...
const HomeBanner = () => {
    ...
    return (
        <div id="carouselExampleCaptions" className="carousel slide carousel-fade top text-center" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-item active" data-bs-interval="5000" >
                    ...
                    <div
                        className="carousel-caption container w-100  d-flex flex-column align-items-center align-items-md-center justify-content-end  justify-content-md-center mb-5 mb-md-0">
                        <h5 className="text-center text-md-start title1">Make Your Fitness</h5>
                        <h5 className="text-center text-md-start title1 text-white">To The Next Level</h5>
                        <p className="text-start slogan ps-5 ps-md-0">PREMIUM ONLINE & INDIVIDUAL PERSONAL FITNESS TRAINING</p>
